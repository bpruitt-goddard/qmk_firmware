...
#define QUOTE_NUM LT(NUM, KC_QUOTE) // Quote key and momentary num layer
#define SCOLON_NUM LT(NUM, KC_SCOLON) // Backslash key and momentary num laye
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ergodox_pretty(
    ...
    GUI_T(KC_BSLASH), GUI_T(KC_SCOLON), KC_COMMA, KC_DOT,  KC_P,    KC_Y,    KC_PERC,           KC_DELETE,    KC_F,    KC_G,    KC_C,      KC_R,    KC_L,        KC_SLASH,
    QUOTE_NUM,        KC_A,             KC_O,     KC_E,    KC_U,    KC_I,                                     KC_D,    KC_H,    KC_T,      KC_N,    KC_S,        GUI_T(KC_MINUS),
